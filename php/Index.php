...
<div id="content_outer">
    <div id="content_inner">
            ...
            <div class="content_middle">
                <div class="content_block"><a href="Reports.php" class="content_link">
                        <span class="content_link_text">Reports&nbsp;</span></a><!--<div class="alert1"></div>--></div>
                <div class="content_block"><a href="Enrolment.php" class="content_link">
                        <span class="content_link_text">Student Enrolment<br>&nbsp;</span></a></div>
                <div class="content_block"><a href="Admin.php" class="content_link">
                        <span class="content_link_text">Admin Panel<br>&nbsp;</span></a></div>
